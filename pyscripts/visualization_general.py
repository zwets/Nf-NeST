...
dic3={'A':'AL','B':'CQ','C':'CQ+PQ','D':'AL+PQ','E':'AL+MQ','F':'AS+AQ','G':'AS+SP','H':'AS+MQ','I':'DHA+PQ','J':'AS+SP+PQ','K':'AL+MQ+PQ','L':'Doxxycline','M':'Malarone','N':'Quinine','O':'Quinine+Doxycycline','P':'Atovaquone/Proguanil+AL','Q':'Mefloquine','R':'Vancomycin+Rocephin','S':'Malarone+Doxycycline','x':'None','0':'None'}
...
merge1.columns=['Gene', 'BasePOS', 'BaseDepth', 'Agreements', 'Ref', 'Alt', 'AAref',
       'AAalt', 'AAPOS', 'CodonCoverage', 'VAF(DP4)', 'AF', 'Mutation', 'QD',
       'SOR', 'MQ', 'MQRankSum', 'Filter', 'FilterDescription', 'Candidates',
       'Reportable', 'Sample name', 'Year', 'Treatment', 'Day',
...
merge1=merge1[['Gene','BasePOS', 'BaseDepth', 'Ref', 'Alt', 'AAref', 'AAalt','Agreements',
       'AAPOS', 'CodonCoverage', 'VAF(DP4)','AF','Mutation', 'QD', 'SOR', 'MQ',
       'MQRankSum', 'Filter', 'FilterDescription', 'Candidates', 'Reportable',
       'Sample name', 'Reportable mutation with gene','Reportable mutation','Drug Resistance Marker','Treatment','Day']]

summary=merge1[['Sample name','Gene','Ref', 'Alt', 'AAref', 'AAalt','Agreements',
       'AAPOS', 'CodonCoverage', 'VAF(DP4)','Mutation','Drug Resistance Marker','QD', 
       'SOR', 'MQ','MQRankSum', 'Filter', 'FilterDescription','Treatment','Day']]
...
merge1_AAonly=test3[['Gene','AAref', 'AAalt', 'AAPOS',
       ...
       'Sample name','VAF(DP4)','Reportable mutation', 'Drug Resistance Marker','Treatment'
       ]]
merge1_AAonly.columns=['Gene','AAref', 'AAalt', 'AAPOS',
       'CodonCoverage', 'AF', 'Mutation', 'QD', 'SOR', 'MQ', 'MQRankSum',
       'Filter', 'FilterDescription', 'Candidates', 'Reportable',
       'Sample name','VAF','Reportable mutation', 'Drug Resistance Marker','Treatment'
       ]
...
bi_out=summary[['Sample name','Gene', 'AAref', 'AAalt', 'AAPOS', 'VAF(DP4)', 'Mutation',
        ...
        'flagged','Treatment']]
bi_out.to_csv("result_table.csv")