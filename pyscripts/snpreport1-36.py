...
PfCRTStartlist1=[96,366,812,1161,1443,1644,1812,2020,2214,2416,2702,2891,3115]
PfCRTEndlist1=[x+y for x,y in zip([96,366,812,1161,1443,1644,1812,2020,2214,2416,2702,2891,3115],[89,266,171,128,71,68,80,50,50,89,41,54,76])]
#PfCRTStartlist1=[96,363,812,1157,1443,1638,1810,2020,2208,2413,2699,2891,3115]
#PfCRTEndlist1=[x+y for x,y in zip([96,363,812,1155,1443,1638,1809,2020,2208,2413,2699,2891,3114],[89,269,170,134,71,75,83,50,56,92,44,54,77])]
DHFRStartlist1=[1]
DHFREndlist1=[x+y for x,y in zip([1],[1827])]
K13Startlist1=[1]
K13Endlist1=[x+y for x,y in zip([1],[2181])]
    ...
    for line in f4:
        ...
        if count==2 and tempGene1=="PfCRT":
            ...
            for x in range(len(PfCRTStartlist1)):
                tempcount=0
                tempcodon=""
                for y in range(PfCRTStartlist1[x]-1,PfCRTEndlist1[x]+2):
                    tempcount+=1
                    #print(tempGene1,y)
                    if tempcount==1:
