...
#PfMDR1  1   4260    PfMDR1  .   +   1   4260    0   1   4260,   1,
   ...
   # print(len(Genelist1))
    ...
    for x in range(len(QDlist1)):
        ...
        if QDlist1[filtercount] != "None" and  SORlist1[filtercount]!="None" and MQlist1[filtercount]!="None" and  MQRankSumlist1[filtercount]!="None" :
            filterlist1+=["N/A"]
        elif MQRankSumlist1[filtercount]!="None" and MQRankSumlist1[filtercount] <-2:
                filterlist1+=["invalid MQRankSum"]
        elif SORlist1[filtercount] >1:
                filterlist1+=["SOR is higher than 1"]
        elif (QDlist1[filtercount] != "None" and QDlist1[filtercount]<15 or MQlist1[filtercount]!="None" and MQlist1[filtercount]<35) and SORlist1[filtercount] <= 1:
                            # SORlist1[filtercount]=SORlist1[filtercount].replace("None",0)
            filterlist1+=[str(((QDlist1[filtercount]/15)+(MQlist1[filtercount])/35)/2)]
        else:
            filterlist1+=["1"]
    #print(filterlist1)
                        #print(word+"test2222")
